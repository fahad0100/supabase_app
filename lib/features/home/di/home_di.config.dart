...
import 'package:supabase_app/features/home/data/datasources/home_remote_data_source.dart'
    as _i470;
import 'package:supabase_app/features/home/data/repositories/home_repository_data.dart'
    as _i761;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt initHome({
    ...
    gh.lazySingleton<_i470.BaseHomeRemoteDataSource>(
      () => _i470.HomeRemoteDataSource(
        gh<_i828.LocalKeysService>(),
        gh<_i454.SupabaseClient>(),
      ),
    );
    gh.lazySingleton<_i526.HomeRepositoryDomain>(
      () => _i761.HomeRepositoryData(gh<_i470.BaseHomeRemoteDataSource>()),
    );
    gh.lazySingleton<_i859.HomeUseCase>(
      () => _i859.HomeUseCase(gh<_i526.HomeRepositoryDomain>()),
    );
    return this;
  }
}
